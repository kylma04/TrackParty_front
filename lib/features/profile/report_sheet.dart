...
class _ReportSheetState extends ConsumerState<ReportSheet> {
  ...
  static const _reasons = [
    (
      emoji: '⚠️',
      title: 'Événement frauduleux',
      sub: 'Faux event, arnaque',
      api: 'fraud',
    ),
    (
      emoji: '🚫',
      title: 'Contenu inapproprié',
      sub: 'Violence, haine, illégal',
      api: 'inappropriate',
    ),
    (
      emoji: '🔁',
      title: 'Spam ou duplicata',
      sub: 'Publié plusieurs fois',
      api: 'spam',
    ),
    (
      emoji: '👤',
      title: "Usurpation d'identité",
      sub: 'Se fait passer pour qqn',
      api: 'other',
    ),
    (
      emoji: '⛔',
      title: 'Mineurs en danger',
      sub: 'Protection enfants',
      api: 'inappropriate',
    ),
    (
      emoji: '❓',
      title: 'Autre',
      sub: 'Décris dans le commentaire',
      api: 'other',
    ),
  ];
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Aide-nous à garder TrackParty safe',
                        style: TextStyle(
                          fontSize: 12,
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(Radii.button),
                      border: Border.all(
                        color: active ? kPrimary : context.tpHair,
                        width: 1.5,
                      ),
                    ),
                    child: Row(
                      children: [
                        ...
                        AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: active
                                ? null
                                : Border.all(color: context.tpHair, width: 2),
                          ),
                          child: active
                              ? Icon(
                                  PhosphorIcons.check(),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Dis-nous ce qui se passe pour nous aider à comprendre…',
                  hintStyle: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w600,
            ...
            Center(
              child: Text(
                '🔒 Anonyme · Notre équipe modération examine sous 24h',
