                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            count > 0
                                ? '$count événement${count > 1 ? 's' : ''} sauvegardé${count > 1 ? 's' : ''}'
                                : 'Découvre et sauvegarde des events',
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                              color: context.tpInkSub,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Semantics(
            button: true,
            label: 'Invitations co-organisateur',
            child: GestureDetector(
  ...
  Widget _buildDocuments(BuildContext context, UserModel? user) {
    final (
      ...
      'approved' => (
        ...
        'Ton identité est confirmée',
      ),
      'rejected' => (
        'Refusé',
        kError,
        PhosphorIcons.xCircle(PhosphorIconsStyle.fill),
        'Action requise — reprends tes photos',
      ),
      'manual_review' => (
        'En revue',
        kInfo,
        PhosphorIcons.eye(PhosphorIconsStyle.fill),
        'Examen manuel en cours',
      ),
      _ => (
        'À vérifier',
        kPrimary,
...
class _Divider extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      Container(width: 1, height: 32, color: context.tpHair);
}
